...
if ($current_page !== 'login.php' && !isset($_SESSION["account"])) {
  $_SESSION["redirect_after_login"] = $_SERVER["REQUEST_URI"]; // 記錄原頁面
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
         ...
         <li class="nav-item">
            <a class="nav-link<?=nav_active('job.php')?>" href="job.php">求職</a>
</li>
        </ul>
<ul class="navbar-nav me-auto mb-2 mb-lg-0">
   <?php if (isset($_SESSION['account'])): ?>
    <li class="nav-item">
      <span class="nav-link"><?=htmlspecialchars($_SESSION['account'])?></span>
    </li>
    <li class="nav-item">
